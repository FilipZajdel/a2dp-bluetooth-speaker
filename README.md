ESP-IDF A2DP-SINK with media control buttons
===========================================

This is a modified esp-idf example. Modifications consists of additional buttons used
to controlling media streaming.
...
Default pin usage is shown in the table below.

| ESP pin   | Media action   |
| :-------- | :-----------   |
| GPIO12    | PLAY/SUSPEND   |
| GPIO34    | NEXT SONG      |
...
* Enable media buttons and set their gpio pins and interrupt type
